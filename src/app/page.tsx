export default function Home() {
	return (
		<main className="bg-[#0F1421] flex max-sm:flex-col h-[100vh]">
			...
			<div className="flex flex-col flex-1 justify-center w-full text-zinc-100 h-full items-center">
				<div className="max-sm:w-[80vw]">
					...
					<div className="pl-2 flex items-center gap-4">
						...
						<h2 className="text-3xl max-sm:text-2xl font-semibold">English</h2>
					</div>
					<div className="pl-2 flex items-center gap-4">
